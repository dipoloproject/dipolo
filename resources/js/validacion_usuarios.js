...
$('#form_crear-usuario').on('submit', function(e) {                                                                            //
    e.preventDefault();
                                                                                                     //
            ...
            success: function(data) {       //cuando la llamada sea exitosa, el archivo definido en action devuelve TRUE o FALSE
                ...
                if( data == true) {     //Mostrará notificacion de INSERCION EXITOSA
                    Swal.fire({
                        ...
                        html: '<p class="sweetalert2-html-wellcomeText">¡Operacion EXITOSA!</p> <p class="sweetalert2-html-actionText">Creaste un nuevo usuario</p>',
                    ...
                    setTimeout( function() {
                        window.location.href = 'crear-usuario.php'; //luego de redirigir, se actualiza
